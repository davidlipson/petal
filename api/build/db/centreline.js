...
var Terminus;
(function (Terminus) {
    Terminus["STARTING"] = "starting";
    Terminus["ENDING"] = "ending";
})(Terminus || (Terminus = {}));
const selectAddress = (address, terminus) => {
    return `(select *, '${terminus}-terminus' node_name from addresses a where (full_address = '${address}') limit 1)`;
};
const closestStreet = (terminus) => {
    return `
...
// clean it up :)
const centreline = (starting_address, ending_address) => __awaiter(void 0, void 0, void 0, function* () {
  ...
  `;
    ...
    const query = `with 
      ${Terminus.STARTING} as ${selectAddress(starting_address, Terminus.STARTING)},
